...
<body align="center" class="fundal">
    ...
    <div><img /></div>
    <marquee behavior="scroll" direction="left" id="move">Nu stii ce specializare să alegi? Hai la Media Digitala!</marquee>
    <div>
        <section class="imagini"><br>
            <p>Te pasioneaza fotografia?</p>
            <img src="media/photo.png" alt="poza" class="poza">
            <img src="media/photo.png" alt="poza" class="poza">
            <img src="media/photo.png" alt="poza" class="poza">
        </section>
        <div>
            <section class="imagini"><br>
                <p>Visezi sa publici un articol intr-un ziar?</p>
                <img src="media/photo1.png" alt="poza" class="poza">
                <img src="media/photo1.png" alt="poza" class="poza">
                <img src="media/photo1.png" alt="poza" class="poza">
            </section>
            <section class="imagini"><br>
                <p>Iti place design-ul web?</p>
                <img src="media/photo2.png" alt="poza" class="poza">
                <img src="media/photo2.png" alt="poza" class="poza">
                <img src="media/photo2.png" alt="poza" class="poza">
            </section>
            <section class="imagini"><br>
                <p>Vrei sa aflii mai multe despre aplicatii?</p>
                <img src="media/photo3.png" alt="poza" class="poza">
                <img src="media/photo3.png" alt="poza" class="poza">
                <img src="media/photo3.png" alt="poza" class="poza">
            </section>
            <section class="imagini"><br>
                <p>Nu stii sa editezi, dar vrei sa inveti?</p>
                <img src="media/photo4.png" alt="poza" class="poza">
                <img src="media/photo4.png" alt="poza" class="poza">
                <img src="media/photo4.png" alt="poza" class="poza"><br>
                <p>Atunci te asteptam la Media Digitala!</p><br>
            </section>
