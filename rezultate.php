...
<body class="fundal" align="center">
	...
	<div><img /></div><br>
	<a style="margin-left:50px; font-family:papyrus; font-size:30px;">Lista utilizatori:</a><br>
	...
	<table>
		...
		if ($result->num_rows > 0) {
			...
			while ($row = $result->fetch_assoc()) {
				echo "<td><tr>Nr." . $row['ID'] . "<tr><tr><br><b>username: " . $row['username'] . "</b><tr><tr><br> " . $row['created_at'] . "</tr></td><br>";
			}
		} else {
			echo "0 results";
		}
